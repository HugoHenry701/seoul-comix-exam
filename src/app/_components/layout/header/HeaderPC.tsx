...
export default function HeaderPC({ pathname }: { pathname: string }) {
  // addClass hidden header PC
  useEffect(() => {
    var lastScrollTop = 0;
    const onScroll = () => {
      let check = false;
  ...
  return (
    <>
      {/* PC Header */}
      <div className="hidden lg:block w-full z-10 headerTop" id="body-tag">
        <div className="bg-[#fff] border-b-[1px] border-[#C0C0C0] lg:border-[#000]">
          <div className="mx-auto px-[200px] h-[54px] flex items-center justify-between w-full lg:h-[71px] relative ">
            ...
            <Link href="/feed" className="flex flex-row gap-2 items-center">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <Link href="/menu" className="flex flex-row gap-2 items-center">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
